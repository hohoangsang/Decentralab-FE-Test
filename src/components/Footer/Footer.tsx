...
function Footer({}: Props) {
  return (
    <footer className='mx-auto max-w-maxWidthSection pb-[1rem]'>
      <div className='m-[2rem] flex h-[180px] items-center justify-center bg-footerBg px-4 tablet:h-[250px] laptop:h-[300px] desktop:h-[354px]'>
